...
enum adau1761_digmic_jackdet_pin_mode {
	ADAU1761_DIGMIC_JACKDET_PIN_MODE_NONE = 0,
	ADAU1761_DIGMIC_JACKDET_PIN_MODE_DIGMIC = 1,
	ADAU1761_DIGMIC_JACKDET_PIN_MODE_JACKDETECT = 2,
};
...
enum adau1761_output_mode {
	ADAU1761_OUTPUT_MODE_HEADPHONE = 0,
	ADAU1761_OUTPUT_MODE_HEADPHONE_CAPLESS = 1,
	ADAU1761_OUTPUT_MODE_LINE = 2,
};
