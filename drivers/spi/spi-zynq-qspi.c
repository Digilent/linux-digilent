 ...
 * Supports a maximum of 4 bytes of address passed in op->addr.nbytes.
 *
 * Return: 0 in case of success, -EINVAL on invalid input parameter, another
